...
const IndefiniteEmployeeContract = ({
                                        initials,
                                        lastName,
                                        address,
                                        addressNr,
    ...
    return (
        <div className="prose mx-auto p-6 max-w-4xl text-justify bg-white">
            ...
            <p>
                ...
                the employee's employment contract is renewed in the position as a
            ...
            <p>
                This employment contract has been entered into for an indefinite period. The employment contract can be
                terminated prematurely by mutual agreement with due observance of the statutory notice periods (4
                weeks).
            </p>
            <p>
                This employment contract can be dissolved at the end of the contract, through mutual consent, by
                termination,
                due to bankruptcy of the employer, due to financial need of the employer, by immediate dismissal and /
                or dissolution by court.
            </p>
            ...
            <p>
                The employer maintains flexible working hours and working days. As a result, the employee is free to
                arrange
                their working hours themselves, within reasonable limits. They consider the planning for current
                projects,
                deadlines and any other agreements or urgent requests.
            </p>
            <p>
                When employee's hour balance reaches a negative, employer will give a formal notification that extra
                hours have to be
                worked to compensate for the negative balance. If the hour balance reaches negative one time the weekly
                contractual
                hours, then employer has the right to convert this employee contract into a zero-hour contract until the
                hour balance of
            ...
            <p>
                Every year, the employee is entitled to a holiday allowance of 8% on the annual gross salary. This
                holiday allowance is paid every month.
            </p>

            <h2 className={"font-bold"}>Article 8. Pension provision</h2>
            <p>
                A pension provision is made for the employee. The pension provision amounts to 8% of the annual gross
                salary
...
export default IndefiniteEmployeeContract;